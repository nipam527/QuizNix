...
// const BASE_URL = 'https://quiznix-535j.onrender.com';
...
//     if (code) {
//       fetchUsers(code, token);
//     }
//   }, [code, navigate]);

//   const fetchUsers = async (roomCode, token) => {
//     try {
//       const res = await axios.get(`${BASE_URL}/api/room/users?code=${roomCode}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     if (!code) {
//       toast.warn('Please create a room first');
//       return;
//     }
//     navigate(`/quiz/${code}`);
//   };
...
//     const token = localStorage.getItem('token');
//     if (code && token) fetchUsers(code, token);
//   };
...
//       >
//         <h2 className="text-2xl font-bold mb-4 text-[#2C3E50]">Create a Quiz Room</h2>
//         <button
//           onClick={handleCreateRoom}
//           className="bg-[#3498DB] hover:bg-[#2980B9] text-white font-semibold px-5 py-2 rounded-full transition duration-300"
//         >
//           Create Room
//         </button>
...
//               <strong>Room Code:</strong> <span className="text-[#D4AF37]">{code}</span>
//             </p>

//             <div className="mt-6 flex items-center justify-between border rounded-xl px-4 py-2 bg-[#E0E0E0]">
//               <div className="flex items-center gap-2 text-[#606060]">
//                 <FaUsers />
//                 <span>{users.length} user(s)</span>
//               </div>
//               <button onClick={handleRefreshUsers} className="text-[#3498DB] hover:rotate-90 transition-transform">
//                 <IoReload size={20} />
//               </button>
//             </div>
...
//                 <li key={index} className="py-1 px-3 bg-[#F9F9F9] rounded mb-2 text-[#2C3E50] shadow-sm">
//                   {user.name}
//                 </li>
//               ))}
//             </ul>
...
//               className="mt-6 bg-[#D4AF37] hover:bg-yellow-600 text-white font-bold py-2 px-6 rounded-full transition"
//             >
//               Start Quiz
//             </motion.button>
//           </>
